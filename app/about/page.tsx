        ...
        <div className="mx-auto max-w-15xl px-8 py-16 md:px-16 md:py-20">
          ...
          <div className="grid gap-12 md:grid-cols-[0.8fr_1.2fr]">
            ...
            <div className="space-y-5 text-base leading-7 text-[#475569]">
              ...
              <p>
                The realization that first drew me deeper into computing was surprisingly simple: every response generated by a large language model ultimately emerges from a system whose fundamental task is to predict the most probable next token given a sequence of previous tokens. Yet from this elementary objective emerges the ability to code, create, and reason.</p> <p>The more I thought about it, the more the scale of it all captivated me. A prompt typed on my laptop is transformed into packets, travels across networks, and triggers billions of numerical operations, all to return an answer in seconds. I became fascinated not only by what these systems could do, but by the layers of abstraction that make them possible.</p>
            </div>
          </div>
        </div>
      </section>
